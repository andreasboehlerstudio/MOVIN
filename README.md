...
- Saettigung von Larissas Portraet auf Kundenwunsch dezent erhoeht.
...
- Portraetgroesse auch auf der Mooswald-Seite angeglichen.
...
- Neue EHC-Stadionfassung des Sportphysiotherapie-Spots unter "Unsere starken Partner" auf der Startseite integriert.
- Video lokal, responsiv und ohne externe YouTube-Cookies ausgeliefert.
...
- Frueher indexierte Seite unter `/stadtbeste-physiotherapie/` im aktuellen MOVIN Design rekonstruiert.
- Historische Auszeichnungen aus 2016 und 2017 transparent eingeordnet und mit aktuellen Standorten und Leistungen verknuepft.
- Canonical, strukturierte Daten, Sitemap, Serverrouting und interne Verlinkung fuer den Erhalt der alten URL ergaenzt.
...
- Auf Staging gepruefte Optimierung des Bewerbungs-PDF-Versands nach Production uebernommen.
- Endlose Ladeanzeige durch ein verbindliches 60-Sekunden-Timeout verhindert.
- Uploadgrenzen fuer stabilen SMTP-Versand auf 10 MB pro PDF und 15 MB gesamt angepasst.
- Status- und Fehlermeldungen fuer Vorbereitung, Versand, Zeitueberschreitung und Rate-Limit verbessert.
...
- Formularaufrufe nach realem IONOS-Test auf direkte PHP-Endpunkte umgestellt.
- PHP-Ausfuehrung und Zugriffsschutz fuer SMTP-Konfiguration auf Staging bestaetigt.
- Ohne SMTP-Zugangsdaten antworten die Formulare erwartungsgemaess mit HTTP 503.
