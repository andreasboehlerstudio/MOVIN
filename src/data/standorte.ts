export const standorteData = {
  'physiotherapie-freiburg-lorettoberg': {
    ...
    description: 'Unsere Boutique-Praxis im Herzen von Freiburg bietet dir modernste Therapie in einer entspannten Wohlfühlatmosphäre. In unserer Praxis am Lorettoberg verbinden wir 20 Jahre Erfahrung mit innovativen Therapieansätzen. Unser spezialisiertes Team aus Physiotherapeuten und Sportwissenschaftlern erarbeitet mit dir individuelle Lösungen für deine Beschwerden.',
    highlights: [
      'Barrierefreier Zugang',
      'Kostenlose Parkplätze',
      'Klimatisierte Räume',
      'Modernster Trainingsbereich',
  ...
  'physiotherapie-freiburg-mooswald': {
    ...
    highlights: [
      ...
      'Exklusives Boutique-Design',
      'Großer Medical Fitness Bereich',
      'Sportphysiotherapie-Schwerpunkt',
  ...
  'physiotherapie-europa-park-rust': {
    ...
    description: 'Unser Standort in Rust bietet erstklassige physiotherapeutische Versorgung direkt am Europa-Park. Wir betreuen sowohl Mitarbeiter und Künstler des Parks als auch Patienten aus der gesamten Region. Unsere Praxis ist auf schnelle Intervention bei akuten Schmerzen sowie auf langfristige Prävention und Rehabilitation spezialisiert.',
    highlights: [
      'Zentrale Lage am Europa-Park',
      'Spezialisierung auf Künstler-Betreuung',
      'Akut-Termine innerhalb 48h',
      'Manuelle Therapie & Osteopathie-Techniken',
